...
const arrayStartsWith_1 = require("../util/arrayStartsWith");
const isPathDescendantOf_1 = require("../util/isPathDescendantOf");
...
const SCHEMA_PATH = path_1.default.join(constants_1.PACKAGE_ROOT, "rojo-schema.json");
const validateRojo = new Lazy_1.Lazy(() => ajv.compile(JSON.parse(fs_extra_1.default.readFileSync(SCHEMA_PATH).toString())));
