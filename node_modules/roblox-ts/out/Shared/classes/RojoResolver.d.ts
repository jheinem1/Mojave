...
export declare type RbxPath = ReadonlyArray<string>;
export declare type RelativeRbxPath = ReadonlyArray<string | RbxPathParent>;
...
export declare type RbxPathParent = typeof RbxPathParent;
export declare class RojoResolver {
    static findRojoConfigFilePath(projectPath: string): string | undefined;
