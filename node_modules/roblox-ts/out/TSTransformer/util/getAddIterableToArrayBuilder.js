...
const addArray = (state, expression, arrayId, lengthId) => {
    const inputArray = state.pushToVarIfNonId(expression, "array");
    return LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.CallStatement, {
        expression: LuauAST_1.default.call(LuauAST_1.default.globals.table.move, [
            inputArray,
            LuauAST_1.default.number(1),
            LuauAST_1.default.unary("#", inputArray),
            LuauAST_1.default.binary(lengthId, "+", LuauAST_1.default.number(1)),
            arrayId,
        ]),
    }));
};
const addString = (state, expression, arrayId, lengthId) => {
    const valueId = LuauAST_1.default.tempId("char");
    return LuauAST_1.default.list.make(LuauAST_1.default.create(LuauAST_1.default.SyntaxKind.ForStatement, {
...
const addSet = (state, expression, arrayId, lengthId) => {
...
const addMap = (state, expression, arrayId, lengthId) => {
...
const addIterableFunction = (state, expression, arrayId, lengthId) => {
...
const addIterableFunctionLuaTuple = (state, expression, arrayId, lengthId) => {
...
const addGenerator = (state, expression, arrayId, lengthId) => {
