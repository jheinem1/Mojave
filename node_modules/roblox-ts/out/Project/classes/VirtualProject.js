...
class VirtualProject {
    constructor() {
        ...
        this.data = {
            ...
            nodeModulesPath: VirtualFileSystem_1.pathJoin(PROJECT_DIR, constants_1.NODE_MODULES),
            noInclude: false,
            pkgVersion: "",
        ...
        this.compilerOptions = {
            ...
            typeRoots: [VirtualFileSystem_1.pathJoin(this.data.nodeModulesPath, constants_1.RBXTS_SCOPE)],
        ...
        this.rojoResolver = RojoResolver_1.RojoResolver.synthetic(OUT_DIR);
