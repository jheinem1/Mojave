...
export declare type FilterDeclarations<T extends RemoteDeclarations> = {
...
export declare type DeclarationLike = FunctionDeclarationLike | AsyncFunctionDeclarationLike | EventDeclarationLike;
...
export declare const DeclarationTypeCheck: import("../internal/validator").Validator<"Function" | "AsyncFunction" | "Event" | "Namespace">;
