...
export class Faction {
    ...
    constructor(public groupInfo: GroupInfo) {
        ...
        this.uniformTop = tonumber(string.match(groupInfo.Description, `UniformTop:%s*["']([^%s]*)["'` + "]")[0]);
        this.uniformBottom = tonumber(string.match(groupInfo.Description, `UniformBottom:%s*["']([^%s]*)["']`)[0]);
